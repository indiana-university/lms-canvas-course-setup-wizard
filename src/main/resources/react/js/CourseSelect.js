  ...
  render() {
    ...
    if (courses.length > 0) {
        return (
          ...
          <>
              <label className="rvt-label rvt-ts-18" id="course-select-label" htmlFor="course-select-input">Import from course <span class="rvt-sr-only sr-spacing"> Required</span></label>
              <Select
