# lms-canvas-course-setup-wizard
LTI tool which allows for a wizard-like experience to setup a course in Canvas.
...
Insert a record into the `LTI_13_AUTHZ` table with your tool's registration_id (`lms_coursesetupwizard`), along with the client_id
